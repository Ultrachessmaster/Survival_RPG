...
public class HitBox {
    ...
    public void UpdatePolygon() {
		...
		polygon.Points = new Vector2[4];
		polygon.Points[0] = (angleoffsets[0]);
		polygon.Points[2] = (angleoffsets[2]);
		polygon.Points[1] = (angleoffsets[1]);
		polygon.Points[3] = (angleoffsets[3]);
		polygon.BuildEdges ();
	}
	...
	/*public bool IsOverlapping(CollisionSim col) {
		return Mathf.Max (points[lowbound].x, col.points[lowbound].x) < Mathf.Min (points[highbound].x, col.points[highbound].x)
			&& Mathf.Max (points[lowbound].y, col.points[lowbound].y) < Mathf.Min (points[highbound].y, col.points[highbound].y);
	}*/
